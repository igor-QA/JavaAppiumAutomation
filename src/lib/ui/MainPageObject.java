...
public class MainPageObject {
    ...
    public void swipeUp(int timeOfSwipe) {
        ...
        int end_y = (int) (size.height * 0.2);
                ...
                action.release();
                action.perform(); //нажатие, ожидание след действия, сам свайп, отпускание и выполнение всех действий
    }
    public void swipeElementToLeft(By by, String error_message)
    {
        ...
        TouchAction action = new TouchAction(driver);
                ...
                action.waitAction(300); //здесь лучше 300мс, иначе на тормозных девайсах
                // свайп не отработает
